create table bookTBL(
		code number(4) primary key, --가변문자열 형식 : varchar2(한글3byte/영어1byte) / nvarchar2(한글1byte)
...
insert into bookTBL(code,title,writer,price) values(1003,'자바 1000제','김용만',26000);